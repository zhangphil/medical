...
public class CommentListViewFooter extends LinearLayout {
	...
	public CommentListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		LinearLayout moreView = (LinearLayout) LayoutInflater.from(mContext)
				.inflate(R.layout.commentlistview_footer, null);
		addView(moreView);

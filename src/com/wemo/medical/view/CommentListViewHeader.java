...
public class CommentListViewHeader extends LinearLayout {
	 ...
	 * @param attrs
	 */
	public CommentListViewHeader(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		...
		mContainer = (LinearLayout) LayoutInflater.from(context).inflate(
				R.layout.commentlistview_header, null);

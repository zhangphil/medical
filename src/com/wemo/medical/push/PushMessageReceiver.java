...
public class PushMessageReceiver extends FrontiaPushMessageReceiver {
	...
	public void onBind(Context context, int errorCode, String appid,
		...
		preferences = context.getSharedPreferences("medical",
		...
		Log.d(TAG, preferences.getString("channelId", null));
		...
		// if(info != null){
		// http.requestSubmitBaiduPush(info.getId(), userId, channelId);
		// }
	}
	...
	private void updateContent(Context context, String content) {
		...
		Message msg = MainActivity.pushHandler.obtainMessage();
		if (content.equals("投诉处理通知")) {
			// intent.setClass(context.getApplicationContext(),
			// ComplaintsActivity.class);
			msg.what = PUSH_TO_COMPLAITS;
		} else if (content.equals("体检报告通知")) {
			// intent.setClass(context.getApplicationContext(),
			// ExamActivity.class);
			msg.what = PUSH_TO_EXAM;
		} else {
			// intent.setClass(context.getApplicationContext(),
			// HistoryActivity.class);
			msg.what = PUSH_TO_HISTORY;
		}
		msg.sendToTarget();

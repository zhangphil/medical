...
public abstract class DraggableDrawer extends MenuDrawer {
	 ...
	 * closed with regards to touch events.
	 */
	...
	/**
	 * Distance in px from closed position from where the drawer is considered
	 * closed with regards to touch events.
	 */
	...
	/**
	 * Called when a move event has happened while dragging the content is in
	 * progress.
	 * 
	 * @param dx
	 *            The X difference between the last motion event and the current
	 *            motion event.
	 */
	 ...
	 * {@link net.simonvt.menudrawer.MenuDrawer#onTouchEvent(android.view.MotionEvent)}
	 * .
	 * 
	 * @param ev
	 *            The motion event.
	...
	void saveState(Bundle state) {
		final boolean menuVisible = mDrawerState == STATE_OPEN
				|| mDrawerState == STATE_OPENING;

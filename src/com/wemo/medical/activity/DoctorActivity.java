...
import com.wemo.medical.R.drawable;
...
public class DoctorActivity extends Activity implements OnClickListener {
	...
	private TextView doctorTip1;
	private TextView doctorTip2;
	...
	private void initView() {
		...
		imageGroupHead = (ImageView) this.findViewById(R.id.doctor_group_head);
		...
		doctorTip1 = (TextView) this.findViewById(R.id.doctor_tip1);
		doctorTip2 = (TextView) this.findViewById(R.id.doctor_tip2);
	...
	private void cUstype() {
		...
		if (mCusType.equals("198")) {
			...
			dactorName.setVisibility(View.GONE);
			description.setVisibility(View.GONE);
			doctorTip1.setVisibility(View.VISIBLE);
			doctorTip2.setVisibility(View.VISIBLE);
			cover_user_photo.setVisibility(View.GONE);
			imageGroupHead.setVisibility(View.VISIBLE);
		}
